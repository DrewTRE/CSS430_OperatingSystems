 ...
 * @date: 12/13/2016
 *
 * This Project is Scheduler.java which is submitted alongside 
 * multiple other files for the File System project of CSS 430
 *
 * This file required slight modifications 
 */
...
public class Scheduler extends Thread
{
    ...
    public TCB addThread(Thread t)
    {
        ...
        // the following if and for stantements are for file system.
        if (parentTcb != null)
        {
            for (int i = 0; i < 32; i++)
            {
                ...
                // increment the count for any file table entries inherited from parentTcb
                if (tcb.ftEnt[i] != null)
                {
                    tcb.ftEnt[i].count++;
                }
